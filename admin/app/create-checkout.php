...
)
{
    ...
    //$allCoupons = print_r($coupons); //json_encode($coupons);
    $allCoupons = json_encode($coupons , JSON_FORCE_OBJECT);
    // $couponstring = print_r($coupons);
    ...
    <?php
            ...
            $plan_name = "'.$plan_name.'"; 
            $plan_type = "'.$plan_type.'"; 
            $Yearly_payment_special = "'.$Yearly_payment_special.'"; 
            $thank_you_page_url = "'.$thank_you_page_url.'"; 
            $product_price_yearly = "'.$Yearly_Payment_Fee.'";
            $product_price_monthly = "'.$Monthly_Payment_Fee.'";
            $enrolment_fee ='. $Enrollment_Fee.';
