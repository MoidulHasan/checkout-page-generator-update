...
if (
    ...
    if ($query =  mysqli_query($conn,$sql)){
        ...
        if($rowcount>0 && $file_name != $previousFileName){
            $result = "File Name Not Abailable";
            mysqli_free_result($query);
        }
        else{

            $previousFileName ='../../'.$previousFileName.'.php';
             ...
             if(mysqli_query($conn,$sql) )
             {
                ...
                if($CouponData!=NULL){
                    foreach($CouponData as $coupon){
                        ...
                        $sql2 = "SELECT Coupon_code from coupons where checkout_file_id='$last_id' AND Coupon_code='$Coupon_code'";
