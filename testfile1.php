    ...
    <?php
            $URL = "testfile1.php";
            $PAYMENT_URL ="https://www.enrollment123.com/gateway/member.cfm";
            $CORP_ID ="1271";
            $API_USERNAME ="devstat2021";
            $API_PASSWORD ="apM6L_qCQs";
            $AGENT_ID ="617209";
            $PAYMENT_TYPE ="CC";
            $PRODUCT_CODE ="13838";
            $PAYMENT_PROCESS ="Y";
            ...
            $plan_name = "plan 1"; 
            $plan_type = "Family"; 
            $Yearly_payment_special = "2 Month Free"; 
            $thank_you_page_url = "google.com"; 
            $product_price_yearly = "169.96";
            $product_price_monthly = "14.69";
            $enrolment_fee =20;

            $coupons = '{"0":{"Coupon_code":"test1","Coupon_value":"10","Coupon_type":"Flat","coupon_message":"Save $10"},"1":{"Coupon_code":"test2","Coupon_value":"10","Coupon_type":"Percentage","coupon_message":"Save 10%"}}';
            ...
            function proceedPayment($postData)
            {
                ...
                $curlPostData = [
                    ...
                    "PAYMENT_CITY" => $postData["PAYMENT_CITY"],
                    "PAYMENT_STATE" => $postData["PAYMENT_STATE"],
...
<body class="overflow-auto bg-custom p-0 m-0">
    ...
    $(document).ready(function() {
        ...
        let type, value, PRODUCT_FEE = null,
            coupon_code = null, coupon_status = false, discount_monthly=null, discount_yearl=null;
